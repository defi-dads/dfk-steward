...
import { getFullName, getFirstName, getLastName } from '../components/_DeFiKingdoms/_helpers/names'
...
export const RARITY_LEVELS = [RARITY_COMMON, RARITY_UNCOMMON, RARITY_RARE, RARITY_LEGENDARY, RARITY_MYTHIC]
/**
...
export default function buildHero(heroRaw: any, owner: any) {
  ...
  return {
    ...
    class: statGenes.class != undefined ? statGenes.class : statGenes.mainClass,
...
export function buildLineageHero(hero: any = {}) {
  return {
    ...
    class: hero.mainClass.toLowerCase(),
