...
export const DEFAULT_LIST_OF_LISTS: string[] = [
  ...
  KLEROS_LIST,
  GEMINI_LIST,*/
  DEFIKINGDOMS_DEFAULT_LIST,
  DEFIKINGDOMS_COMMUNITY_LIST,
  ...UNSUPPORTED_LIST_URLS // need to load unsupported tokens as well
]

// default lists to be 'active' aka searched across
export const DEFAULT_ACTIVE_LIST_URLS: string[] = [DEFIKINGDOMS_DEFAULT_LIST, DEFIKINGDOMS_COMMUNITY_LIST]
